...
export class MyGridApplicationComponent implements OnInit, OnDestroy {
  ...
  openFormBootStrap() {
    ...
    this.bsModalRef = this.modalService.show(ManualEntryComponent, {initialState: intialState});
  ...
  openForm(): void {
    let dialogRef = this.dialog.open(ManualEntryComponent, {
      //width: '250px',
      data: { 
